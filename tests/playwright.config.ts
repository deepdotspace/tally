...
export default defineConfig({
  ...
  timeout: 30_000,
  // The 2-client realtime specs are timing-sensitive (WS propagation under parallel
  // load); they pass solo but jitter in the full suite, so retry rather than flake.
  retries: 2,
  use: {
    baseURL: BASE_URL,
    headless: true,
